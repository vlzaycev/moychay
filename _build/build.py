...
# ── EN ───────────────────────────────────────────────────────────
EN = dict(
    lang="en", root="", canonical="https://teaphuket.com/", og_locale="en_US", map_lang="en",
    ...
    why_h2="A quiet place in Phuket",
    why_body=paras([
    ...
    about_h2="Part of something bigger, rooted in Phuket since 2024",
    about_body=paras([
    ...
    ways_h2="Something for every level of curiosity",
    ...
    tea_h2="One shelf, a world of flavor",
    ...
    final_h2="Come taste it for yourself",
...
# ── RU ───────────────────────────────────────────────────────────
RU = dict(
    lang="ru", root="../", canonical="https://teaphuket.com/ru/", og_locale="ru_RU", map_lang="ru",
    ...
    hero_h1="Чайный клуб на Пхукете",
    ...
    why_h2="Спокойное место на Пхукете",
    why_body=paras([
    ...
    about_h2="Часть большего сообщества, но со своими корнями с 2024 года",
    about_body=paras([
    ...
    ways_h2="Формат найдётся для любого уровня интереса",
    ...
    tea_h2="Одна полка – целый мир вкуса",
    ...
    final_h2="Приезжайте и попробуйте сами",
